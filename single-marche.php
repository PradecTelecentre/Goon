...
?>
<div class=""
    style="margin-top: 53px; position:relative; background-color: darkorange; height: 375px; border-radius: 1px 1px 100px 100px; padding-top: 30px">
    ...
    <div class="image text-center" style="opacity:0.4; position: relative; text-align:center; color:white;">
        ...
        <div class=""
            style="position: absolute; top:30%; left: 50%;  transform: translate(-50%, -50%); font-size: 44px; color: #FFFFFF; font-weight: 600; font-family: 'Roboto Slab', Sans-serif !important; text-transform: uppercase;">
            MARCHÉ</div>
    </div>
</div>
            ...
            <div class="mainheader" style="margin-bottom:8px">
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                        <a class="btn btn-sm" href="http://www.goon.local/marches/" style="background-color:#865a21">
                            Retour </a>
                    </div>
                </div>
            </div>
            <div class="container " style="">
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-6 col-xs-12 col-sm-12">
                        ...
                        <span class="mr-1">
                            <strong class="shadow-sm" style="font-weight: 600; color: orange;">
                                <?php the_field('article_prix') ?> FCFA</strong>
                        </span>
                        ...
                        <div class="row text-center " style="">
                            <div type="" class=" btn-sm  mb-2 col-md-6 col-lg-6 col-xs-12 col-sm-12"
                                style="font-size:25px; font-weight:600"><?php the_field('article_proprietaire') ?>
                            </div>
                            <div type="" class=" btn-sm px-3 mb-2 col-md-6 col-lg-6 col-xs-12 col-sm-12"
                                style="font-size:30px; font-weight:600"> +237 <?php the_field('article_numero') ?></div>
                        </div>
                    </div>
