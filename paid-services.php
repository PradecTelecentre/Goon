            ...
            <div class="goon-container-fluid">
                <div class="goon-row rows-free no-gutters">
                    <div class="free col paid-content-remove-spac">
                        <a href="#" rel="bookmark">
                            <div class="p-2 style-div-md-4 bg-white">
                                <img src="<?= get_template_directory_uri() . '/src/img/internet.png' ?>" alt="">
                    ...
                    <div class="free col">
                        <a href="http://owncloud.telecentrecameroon.ovh/" rel="bookmark">
                            <div class="p-2 style-div-md-4 bg-white">
                                <img src="<?= get_template_directory_uri() . '/src/img/stockage.png' ?>" alt="">
                                <div class="arrow" style="max-width: 201px; margin-right:auto; margin-left:auto;margin-top: -5px">
                                    <img src="<?= get_template_directory_uri() . '/src/img/cadre.svg'  ?>" alt="" style="margin-top: -33px; width: 100px">
                                </div>
                    ...
                    <div class="free col">
                        <a href="http://owncloud.telecentrecameroon.ovh/" rel="bookmark">
                            <div class="p-2 style-div-md-4 bg-white">
                                <img src="<?= get_template_directory_uri() . '/src/img/applications.png' ?>" alt="">
                                <div class="arrow" style="max-width: 201px; margin-right:auto; margin-left:auto;margin-top: -5px">
                                    <img src="<?= get_template_directory_uri() . '/src/img/cadre.svg'  ?>" alt="" style="margin-top: -33px; width: 100px">
                                </div>
                                <?php if (strpos(home_url('/'), 'lang=en') !== false) { ?>
