        ...
        <div class="col paids" style="margin-top:52px;">
            <div class="goon-container-fluid">
                <div class="goon-row rows-free no-gutters">
                    ...
                    <div class="free col">
                        <a href="http://espace.mandama.cm/owncloud/index.php/login" rel="bookmark" style="background: #f5f5f5 !important">
                            <div class="p-2 style-div-md-4 bg-white" style="background: #f5f5f5 !important">
                    ...
                    <div class="free col">
                        <a href="http:espace.mandama.cm/owncloud/index.php/apps/files/?dir=/&fileid=3" rel="bookmark" style="background: #f5f5f5 !important">
                            <div class="p-2 style-div-md-4 bg-white" style="background: #f5f5f5 !important">
