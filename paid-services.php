        ...
        <div class="col paids" style="margin-top:52px;">
            <div class="goon-container-fluid">
                <div class="goon-row rows-free">
                    ...
                    <div class="free col">
                        <a href="http://owncloud.goon.cm" target="_blank" rel="bookmark" style="background: #fff !important">
                            <div class="p-2 style-div-md-4 bg-white" style="background: #fff !important">
                    ...
                    <div class="free col">
                        <a href="http://owncloud.goon.cm/" rel="bookmark" style="background: #fff !important" data-toggle="modal" data-target="#construction">
                            <div class="p-2 style-div-md-4 bg-white" style="background: #fff !important">
