        ...
        <div class="row" style="margin-left: 1rem;margin-right:2rem;">
            ...
            <div class="col-md-8" style="margin-top: 2rem;">
                <div class="generic-content">
                    <h2 class="headline headline--medium headline--post-title event-summary__title--com"><a
                            href="<?php the_permalink();?>"><?php the_title();?></a></h2>
                    <div class="metabox metabox--com">
                        <p><a class="metabox__blog-home-link meta--com"
                                href="<?php echo site_url('/news');?>"><?php _e('News Page','wpml_theme'); ?></a><span
                                class="metabox__main"></span><?php _e('Posted by ','wpml_theme');?>
