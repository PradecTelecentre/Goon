...
<div class="container mainpage" style="background-color: transparent;  margin-top: -65px;">
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <!-- <a class="btn btn-sm"  href="http://www.goon.local/addarticle"  style="background-color:#865a21">Nouvel article</a> -->
    </div>
        ...
        <div class="col-sm-3 col-md-3 col-lg-3 col-xl-3">
            ...
            <div class="card">
                <?php 
                                ...
                                if(!empty($image)): ?>
                <img src="<?php echo $image['url']; ?>" alt="<?php echo $image['alt']; ?>" style="height: 210px;"
                    ;alt="">
                <?php endif; ?>
                <div class="card-body">
                    <h5 class="text-center"><?php   the_title();  the_field('article_nom') ; ?> </h5>
                    <p class="small text-muted text-uppercase text-center"> <?php the_field('article_quantity') ?>
                        disponible</p>
                    <hr>
